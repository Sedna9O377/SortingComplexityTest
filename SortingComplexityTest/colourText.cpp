...
string ColourText::get_textcolor_code(const int textcolor) { // Linux only
    switch (textcolor) {
...
string ColourText::get_backgroundcolor_code(const int backgroundcolor) { // Linux only
...
string ColourText::get_print_color(const int textcolor) { // Linux only
        return "\033[" + get_textcolor_code(textcolor) + "m";
    }

string ColourText::get_print_color(const int textcolor, const int backgroundcolor) { // Linux only
        return "\033[" + get_textcolor_code(textcolor) + ";" + get_backgroundcolor_code(backgroundcolor) + "m";
    }

void ColourText::print_color(const int textcolor) {
#if defined(_WIN32)
...
void ColourText::print_color(const int textcolor, const int backgroundcolor) {
#if defined(_WIN32)
        static const HANDLE handle = GetStdHandle(STD_OUTPUT_HANDLE);
...
void ColourText::print_color_reset() {
#if defined(_WIN32)
        static const HANDLE handle = GetStdHandle(STD_OUTPUT_HANDLE);
...
void ColourText::println(const string & s = "") {
        cout << s << endl;
    }
void ColourText::print(const string & s = "") {
        cout << s;
    }
void ColourText::print(const string & s, const int textcolor) {
        print_color(textcolor);
        cout << s;
        print_color_reset();
    }
void ColourText::print(const string & s, const int textcolor, const int backgroundcolor) {
        print_color(textcolor, backgroundcolor);
        cout << s;
        print_color_reset();
    }
void ColourText::print_no_reset(const string & s, const int textcolor) { // print with color, but don't reset color afterwards (faster)
        print_color(textcolor);
        cout << s;
    }
void ColourText::print_no_reset(const string & s, const int textcolor, const int backgroundcolor) { // print with color, but don't reset color afterwards (faster)
        print_color(textcolor, backgroundcolor);
        cout << s;
    }